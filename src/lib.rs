...
//! assert_eq!(band.progress(), None); // consume 2 from iterator
//!
//! // needs space, pops first item
//! assert_eq!(band.progress(), Some(0)); // consumes 3 from iterator, iterator has no more values
//!
